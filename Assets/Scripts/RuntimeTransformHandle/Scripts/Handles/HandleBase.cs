...
public abstract class HandleBase : MonoBehaviour
{
    ...
    protected void InitializeMaterial()
    {
        ...
        _material = new Material(Resources.Load<Shader>("HandleShader"));
        // _material = new Material(Resources.Load<Shader>("Gizmoz"));
    ...
    {
        _material.color = _defaultColor;
        _parentTransformHandle.gizmoEnabled = false;
    }
        
    public void SetColor(Color p_color)
    {
        _material.color = p_color;
        _parentTransformHandle.gizmoEnabled = true;
    }
